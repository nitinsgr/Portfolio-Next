...
export const AboutProject = () => {
  return(
    <div className=" bg-gray-50">
      ...
      <h1 className="text-5xl bg-yellow-400 text-black p-4">01</h1>
      <h2 className="text-3xl bg-blue-extraDark p-4">Travelodge Website Design/Development</h2>
      </div>
      <div className="pt-52 font-poppins max-w-7xl mx-auto pb-20">
        <h3 className="text-5xl pb-5 text-black  font-bold">About Project </h3>
        <p className="text-2xl text-black ">Travelodge is a Hotels and lodge Booking/Enquiry Website They provide rich expeirence of wilderness of south Africa region.  </p>
      </div>
    </div>
  )
}
  ...
  return(
    <div className=" bg-gray-50 h-500 font-poppins">
      <div className=" max-w-7xl mx-auto">
        ...
        <p className=" w-3/4 text-2xl text-white-white pl-10 pt-10 pb-10">Working on the landing page gave me good knowledge to understand the target and the audience that was using the product. The challenge was to design a product used by managers and learners at the same time. </p>
